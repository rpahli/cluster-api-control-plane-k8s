...
import (
	...
	"sigs.k8s.io/cluster-api-provider-nested/pkg/kubeadm/remote/util/patches"
	"sigs.k8s.io/cluster-api-provider-nested/pkg/kubeadm/remote/util/users"
)
...
// NewSecretVolume creates a v1.Volume with a secret mount to the specified location
...
func GetAPIServerProbeAddress(endpoint *bootstrapv1.APIEndpoint) string {
...
func GetControllerManagerProbeAddress(cfg *bootstrapv1.ClusterConfiguration) string {
...
func GetSchedulerProbeAddress(cfg *bootstrapv1.ClusterConfiguration) string {
...
// port and scheme
func GetEtcdProbeEndpoint(cfg *bootstrapv1.Etcd, isIPv6 bool) (string, int, v1.URIScheme) {
	localhost := "127.0.0.1"
	if isIPv6 {
		localhost = "::1"
	}
