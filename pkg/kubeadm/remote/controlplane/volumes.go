...
func getInClusterVolumesForTheControlPlane(cfg *bootstrapv1.ClusterConfiguration, controlPlaneSecret string) controlPlaneHostPathMounts {
...
func (c *controlPlaneHostPathMounts) NewSecretMount(component, mountName, secretName, containerPath string, readOnly bool) {
	vol := staticpodutil.NewSecretVolume(mountName, secretName)
...
func (c *controlPlaneHostPathMounts) AddExtraHostPathMounts(component string, extraVols []bootstrapv1.HostPathMount) {
...
func getEtcdCertVolumes(etcdCfg *bootstrapv1.ExternalEtcd, k8sCertificatesDir string) ([]v1.Volume, []v1.VolumeMount) {
