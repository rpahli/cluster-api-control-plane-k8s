...
import (
	...
	"sigs.k8s.io/cluster-api-provider-nested/pkg/kubeadm/remote/util/pkiutil"
)
...
func UsingExternalCA(cfg *bootstrapv1.ClusterConfiguration) (bool, error) {
...
// In case we are using an external front-proxy CA, the function validates the certificates signed by front-proxy CA that should be provided by the user.
func UsingExternalFrontProxyCA(cfg *bootstrapv1.ClusterConfiguration) (bool, error) {
